...
import com.testing.imageview.controller.PointDraw
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        modeList.add(PointDraw(imageView,bitmap, Point(100,100)))
        modeList.add(PointDraw(imageView,bitmap, Point(50,50)))
